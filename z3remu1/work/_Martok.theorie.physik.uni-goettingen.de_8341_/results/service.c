...
const int nvar_ext = 14;

const int nfunc_ext = 8;

char * varName_ext[23]={"P(cms)"
,"Mh"
,"MZ2"
,"VEW"
,"MDZ"
...
,14, 8, varName_ext,va_ext,2, 3, 1, &pinf_ext, &pinfAux_ext, polarized_ext, &calcFunc_ext, &BWrange_ext,&twidth_ext,&gtwidth_ext,&gswidth_ext, &aWidth_ext, &sqme_ext,&den_info_ext,cb_ext};
