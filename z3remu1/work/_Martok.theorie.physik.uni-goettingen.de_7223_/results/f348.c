...
#include"num_out.h"
#include"num_in.h"
extern FNN F348_p19p19_p19a19a19_u;
...
REAL F348_p19p19_p19a19a19_u(double GG,REAL*DP,REAL*Q0,COMPLEX*Q1,REAL*Q2,REAL*
 cb_coeff)
{
...
Prop=1*(gtwidth_p19p19_p19a19a19_u? creal(Q1[15]):Q1[15])*(gtwidth_p19p19_p19a19a19_u? creal(Q1[10]):
 Q1[10])*(gtwidth_p19p19_p19a19a19_u? creal(Q1[20]):conj(Q1[20]));
