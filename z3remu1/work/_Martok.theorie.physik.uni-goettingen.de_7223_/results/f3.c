...
#include"num_out.h"
#include"num_in.h"
extern FNN F3_p19p19_p19a19a19_u;
...
REAL F3_p19p19_p19a19a19_u(double GG,REAL*DP,REAL*Q0,COMPLEX*Q1,REAL*Q2,REAL*
 cb_coeff)
{
...
Prop=1*(gtwidth_p19p19_p19a19a19_u? creal(Q1[9]):Q1[9])*(gswidth_p19p19_p19a19a19_u? creal(Q1[1]):Q1[1])*(
 gtwidth_p19p19_p19a19a19_u? creal(Q1[11]):conj(Q1[11]))*(gswidth_p19p19_p19a19a19_u? creal(Q1[12]):conj(
 Q1[12]));
