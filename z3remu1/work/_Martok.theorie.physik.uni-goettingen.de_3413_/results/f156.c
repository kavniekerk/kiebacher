...
#include"num_out.h"
#include"num_in.h"
extern FNN F156_p19p19_p19a19a19_u;
...
REAL F156_p19p19_p19a19a19_u(double GG,REAL*DP,REAL*Q0,COMPLEX*Q1,REAL*Q2,REAL*
 cb_coeff)
{
...
R*=(N/D);
Prop=1*(gtwidth_p19p19_p19a19a19_u? creal(Q1[11]):Q1[11])*Q2[8]*(gtwidth_p19p19_p19a19a19_u? creal(Q1[17])
 :conj(Q1[17]));
