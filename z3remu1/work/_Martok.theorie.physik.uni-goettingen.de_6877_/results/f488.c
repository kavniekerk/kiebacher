...
#include"num_out.h"
#include"num_in.h"
extern FNN F488_p19p19_p19a19a19_u;
...
REAL F488_p19p19_p19a19a19_u(double GG,REAL*DP,REAL*Q0,COMPLEX*Q1,REAL*Q2,REAL*
 cb_coeff)
{
...
R=+2*(DP[0]*(DP[2]-DP[0]+DP[3])+DP[1]*(DP[1]+DP[2]+DP[3]))+DP[0]*(4*DP[4]-
 C[1])+DP[1]*(4*DP[4]-C[1]);
R*=(N/D);
Prop=1*Q2[16]*(gswidth_p19p19_p19a19a19_u? creal(Q1[10]):Q1[10])*(gtwidth_p19p19_p19a19a19_u? creal(
 Q1[19]):conj(Q1[19]));
