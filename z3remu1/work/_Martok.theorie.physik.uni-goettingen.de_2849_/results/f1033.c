...
#include"num_out.h"
#include"num_in.h"
extern FNN F1033_p19p19_p19a19a19_u;
...
REAL F1033_p19p19_p19a19a19_u(double GG,REAL*DP,REAL*Q0,COMPLEX*Q1,REAL*Q2,REAL*
 cb_coeff)
{
...
Prop=1*(gtwidth_p19p19_p19a19a19_u? creal(Q1[20]):Q1[20])*(gtwidth_p19p19_p19a19a19_u? creal(Q1[16]):
 Q1[16])*(gtwidth_p19p19_p19a19a19_u? creal(Q1[22]):conj(Q1[22]));
