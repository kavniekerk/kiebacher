...
#include"num_out.h"
#include"num_in.h"
extern FNN F446_p19p19_p19a19a19_u;
...
REAL F446_p19p19_p19a19a19_u(double GG,REAL*DP,REAL*Q0,COMPLEX*Q1,REAL*Q2,REAL*
 cb_coeff)
{
...
R=+DP[0]*(2*(DP[0]-DP[2])+C[5]-6*DP[1]-3*DP[3]-DP[4])+DP[1]*(4*(DP[1]+DP[2]+
 ...
 DP[4];
R*=(N/D);
Prop=1*(gtwidth_p19p19_p19a19a19_u? creal(Q1[7]):Q1[7])*Q2[14]*(gswidth_p19p19_p19a19a19_u? creal(Q1[18]):
 conj(Q1[18]));
