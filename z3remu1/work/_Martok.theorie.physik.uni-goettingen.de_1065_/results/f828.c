...
#include"num_out.h"
#include"num_in.h"
extern FNN F828_p19p19_p19a19a19_u;
...
REAL F828_p19p19_p19a19a19_u(double GG,REAL*DP,REAL*Q0,COMPLEX*Q1,REAL*Q2,REAL*
 cb_coeff)
{
...
R=+DP[0]*(C[1]+DP[0]-4*DP[2]-2*DP[4])+DP[2]*(4*(DP[2]+DP[4])-C[2])+DP[4]*(
 DP[4]-C[1])+C[3];
R*=(N/D);
Prop=1*Q2[20]*(gswidth_p19p19_p19a19a19_u? creal(Q1[1]):Q1[1])*(gswidth_p19p19_p19a19a19_u? creal(Q1[14]):
 conj(Q1[14]));
