...
#include"num_out.h"
#include"num_in.h"
extern FNN F972_p19p19_p19a19a19_u;
...
REAL F972_p19p19_p19a19a19_u(double GG,REAL*DP,REAL*Q0,COMPLEX*Q1,REAL*Q2,REAL*
 cb_coeff)
{
...
R=+2*(DP[0]*(DP[1]+DP[2]-DP[3]-DP[4])+DP[4]*DP[3]-S[0]-S[1])+DP[1]*(C[1]-4*
 ...
 DP[4]-C[1]);
R*=(N/D);
Prop=1*Q2[18]*(gswidth_p19p19_p19a19a19_u? creal(Q1[14]):Q1[14])*(gswidth_p19p19_p19a19a19_u? creal(
 Q1[15]):conj(Q1[15]));
