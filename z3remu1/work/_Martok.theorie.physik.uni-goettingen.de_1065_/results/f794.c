...
#include"num_out.h"
#include"num_in.h"
extern FNN F794_p19p19_p19a19a19_u;
...
REAL F794_p19p19_p19a19a19_u(double GG,REAL*DP,REAL*Q0,COMPLEX*Q1,REAL*Q2,REAL*
 cb_coeff)
{
 ...
 *(gtwidth_p19p19_p19a19a19_u? creal(Q1[20]):conj(Q1[20]))*(gswidth_p19p19_p19a19a19_u? creal(Q1[14]):
 conj(Q1[14]));
